...
export const SOUND_SECTIONS: SoundSection[] = [
  ...
  },
  {
    ...
    emoji: '💧',
    data: [
      { id: 'sea', title: 'Sea', image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', category: 'Water' },
      { id: 'waves-3d', title: 'Waves 3D', image: 'https://images.unsplash.com/photo-1501959915551-4e8a04a3d0c5?q=80&w=800', category: 'Water' },
      { id: 'ocean-waves', title: 'Ocean Waves', image: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?q=80&w=800', category: 'Water' },
      { id: 'sea-shore', title: 'Sea Shore', image: 'https://images.unsplash.com/photo-1505461791122-2b1b7b3a60b0?q=80&w=800', category: 'Water' },
      { id: 'lake-shore', title: 'Lake Shore', image: 'https://images.unsplash.com/photo-1502082553048-f009c37129b9?q=80&w=800', category: 'Water' },
      { id: 'waterfall', title: 'Waterfall', image: 'https://images.unsplash.com/photo-1502082552891-9e2ffc53f6e6?q=80&w=800', category: 'Water' },
      { id: 'beach', title: 'Beach', image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', category: 'Water' },
      { id: 'river-flow', title: 'River Flow', image: 'https://images.unsplash.com/photo-1504196606672-aef5c9cefc92?q=80&w=800', category: 'Water' },
      { id: 'sprinklers', title: 'Sprinklers', image: 'https://images.unsplash.com/photo-1532634896-26909d0d4b6a?q=80&w=800', category: 'Water' },
    ],
  },
  {
    title: 'Noise',
